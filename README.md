...
│           │   └── components/                  # FighterCard, FightRow, EditionInfo, EditionAISummary
│           ├── predicciones/                    # Predicciones + termómetro + IA + debate
│           │   └── components/
│           │       ├── debate/                  # Modo debate
│           │       ├── AIPrediction.tsx         # Predicción IA por combate
│           │       ├── DNAPredictor.tsx         # ADN de predictor
│           │       ├── ShareFightButton.tsx     # Compartir en redes
│           │       └── CompletionCelebration.tsx # Animación guantes al completar
│           ├── perfil/
